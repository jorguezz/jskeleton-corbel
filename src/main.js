(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['jskeleton',
            'corbel-js',
            'backbone'
        ], function(JSkeleton, corbel, Backbone) {
        ...
        module.exports = factory(root, corbel, JSkeleton, Backbone);

    } else if (root !== undefined) {
        factory.call(root, root, root.corbel, root.Jskeleton, root.Backbone);
    }

})(this, function(root, corbel, JSkeleton, Backbone) {
