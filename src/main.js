(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        var driver = JSkeleton.corbelDriver = corbel.getDriver();

        JSkeleton.di.add('corbel', driver);
        ...
        Backbone.sync = function(method, model, options) {
            ...
            if (requestParams.resourceType || options.resourceType) {
                ...
                if (isCollectionResponse || method === 'create') {
                    builder = resources.collection(fetchData.resourceType);
                } else {
                    id = options.id || model.get('id');
                    builder = resources.resource(fetchData.resourceType, id);
                }
